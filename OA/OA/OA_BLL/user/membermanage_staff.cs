...
namespace OA_BLL.user
{
    ...
    /// 员工类
    /// </summary>
    public class membermanage_staff : BaseUserService ,Imembermanage_staff
    {
        /// <summary>
        /// 新增员工
        /// </summary>
        ...
        public returnresult AddStaff(oa_member_staffs sf)
        {
            ...
            {
                rr.status = Add<oa_member_staffs>(sf);
                if(rr.status)
                {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        sf.email = vsf.email;
                        sf.phone = vsf.phone;
                        sf.departmentid = vsf.departmentid;
        ...
        /// <returns></returns>
        public view_oa_member_staffs_staffsinfos QueryStaffView(long staffid,long companyid)
        {
            return Query<view_oa_member_staffs_staffsinfos>(a=>a.id==staffid && a.companyid==companyid);
        }
