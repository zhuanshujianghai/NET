...
{
    public class admin_membermanage_department : BaseAdminService, Iadmin_membermanage_department
    {
        /// <summary>
        /// 新增部门
        /// </summary>
        ...
        /// <returns></returns>
        public oa_member_departments QueryDepartmentByDepartmentid(long departmentid)
        {
            return Query<oa_member_departments>(a=>a.id==departmentid);
        }
