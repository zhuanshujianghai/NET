...
{
    public class Admin_ProjectController : Admin_BaseController
    {
        /// <summary>
        /// 项目列表
        /// </summary>
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/admin/Admin_Project_ProjectList.html");
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/admin/Admin_Project_EditProject.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            #region 项目信息
            ...
            else
            {
                ...
                var staff = ms.QueryStaffByIdCompanyid(pt.staffid, companyid);
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/admin/Admin_Project_ProjectStaffList.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            long pid = Request.QueryString["pid"].ToLong();
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/admin/Admin_Project_EditProjectStaff.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/admin/Admin_Project_ProjectBugList.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            long pid = Request.QueryString["pid"].ToLong();
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/admin/Admin_Project_ProjectBug.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            long id = Request.QueryString["id"].ToLong();
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/admin/Admin_Project_EditProjectBug.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            long pid = Request.QueryString["pid"].ToLong();
            ...
            else
            {
                ...
                admin_membermanage_staff ms = new admin_membermanage_staff();
                var sf = ms.QueryStaffByIdCompanyid(pbs.editor, companyid);
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/admin/Admin_Project_EditProjectBugEditor.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            long id = Request.QueryString["id"].ToLong();
