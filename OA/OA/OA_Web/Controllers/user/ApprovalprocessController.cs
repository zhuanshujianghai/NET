...
namespace OA_Web.Controllers.user
{
    ...
    public class ApprovalprocessController : BaseController
    {
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/user/ApprovalProcess_ProjectProcessList.html");
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/user/ApprovalProcess_EditProjectProcess.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            #region 项目流程信息
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/user/ApprovalProcess_ProjectList.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            return Content(contentstr);
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/user/ApprovalProcess_EditProject.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            #region 审批项目信息
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/user/ApprovalProcess_ProcessList.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            return Content(contentstr);
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/user/ApprovalProcess_EditProcess.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            #region 审批流程信息
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/user/ApprovalProcess_ApprovalPersonList.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/user/ApprovalProcess_EditApprovalPerson.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            long id = Request.QueryString["id"].ToLong();
            ...
            else
            {
                ...
                if (pp == null)
                {
                    ...
                    contentstr = contentstr.Replace("$processname$", pc.processname);
                    contentstr = contentstr.Replace("$sort$", ap.QueryProcessPersonList(processid, me.companyid).Count + 1 + "");
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/user/ApprovalProcess_StaffApplyList.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            return Content(contentstr);
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/user/ApprovalProcess_StaffApplyApproval.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            long id = Request.QueryString["id"].ToLong();
            ...
            else
            {
                ...
                else
                {
                    ...
                    var sf = ms.QueryStaffByIdCompanyid(sa.staffid,me.companyid);
                    if (sf == null)
                    {
                        contentstr = "申请人信息异常";
                    }
        ...
        {
            string contentstr = "";
            var str = Server.MapPath("/Template/user/ApprovalProcess_ApplyApprovalProcess.html");
            contentstr = System.IO.File.ReadAllText(str, System.Text.Encoding.UTF8);
            string url = Request.Url.LocalPath.ToString();
            contentstr = contentstr.Replace("$topdiv$", gettopdiv()).Replace("$leftdiv$", getleftdiv(url));
            long id = Request.QueryString["id"].ToLong();
            ...
            if (sa == null)
            {
                contentstr = contentstr.Replace("$applyname$", "");
                contentstr = contentstr.Replace("$remark$", "");
                contentstr = contentstr.Replace("$projectprocessid$", "0");
            }
            else
            {
                contentstr = contentstr.Replace("$applyname$", sa.applyname);
                contentstr = contentstr.Replace("$remark$", sa.remark);
                contentstr = contentstr.Replace("$projectprocessid$", sa.projectprocessid+"");
            }
            return Content(contentstr);
        }
	}
